...
import type { CreateSkillInput, ProjectRecord } from '../model/skills'
...
export function CreateSkillDialog({ open, projects, onClose, onCreate }: CreateSkillDialogProps) {
  ...
  const canSubmit = name.trim().length > 0 && !submitting && (scope === 'global' || Boolean(resolvedProject))
